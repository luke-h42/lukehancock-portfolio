...
const CookieBanner = () => {
  return (
    <section class="fixed max-w-2xl p-4 mx-auto bg-white border border-gray-200 md:gap-x-4 right-4 bottom-4  md:flex md:items-center  rounded-2xl">
      <div class="flex items-center gap-x-4">
        ...
        <p class="text-sm text-gray-600 ">
          ...
          website.{" "}
          <a
            href="https://policies.google.com/technologies/cookies?hl=en-UK"
      ...
      <div class="flex items-center mt-6 gap-x-4 shrink-0 lg:mt-0">
        <button class="w-1/2 text-xs text-gray-800 underline transition-colors duration-300 md:w-auto   hover:text-gray-600 focus:outline-none">
          Cookie Setting
        </button>

        <button class=" text-xs w-1/2 md:w-auto font-medium bg-blue-500 rounded-lg hover:bg-blue-600 text-white px-4 py-2.5 duration-300 transition-colors focus:outline-none">
          Accept All Cookies
        </button>
      </div>
    </section>
